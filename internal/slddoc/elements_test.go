...
<path d="M 900 650 v 3 M 900 670 v -3" style="stroke:#962896;stroke-width:1" />
	...
	el, ports, err := parseTwoPortDevice(n, ClassBreaker, "41")
	if err != nil {
		t.Fatal(err)
	}
	if el.Class != ClassBreaker || el.Voltage != "#962896" || el.Name != "В-10 Л-22" {
...
<path d="M 900 270 l -4 4 m 8 0 l -4 -4 M 900 330 l -4 -4 m 8 0 l -4 4" style="stroke:#326400;stroke-width:1" />
	...
	el, ports, err := parseTwoPortDevice(n, ClassBreaker, "43")
	if err != nil {
		t.Fatal(err)
	}
...
<path d="M 900 571 v -1 M 900 589 v 1" style="fill:none;stroke:#962896;stroke-width:1" data-voltage="#962896" />
	...
	el, ports, err := parseTwoPortDevice(n, ClassDisconnector, "162")
	if err != nil {
		t.Fatal(err)
	}
	...
	if el.Voltage != "#962896" {
		t.Errorf("voltage = %q, want #962896 (read from a descendant path, since the <g> itself carries none)", el.Voltage)
	}
}
...
<path d="M 916 612 h -12" data-state="0" style="fill:none;stroke:#962896;stroke-width:1" />
	...
	el, ports, err := parseGroundSwitch(n)
	if err != nil {
		t.Fatal(err)
	}
...
<path d="M 600 795 v 10" data-state="1" style="fill:none;stroke:#962896;stroke-width:1" />
	...
	el, ports, err := parseTwoPortDevice(n, ClassLoadBreakSwitch, "42")
	if err != nil {
		t.Fatal(err)
	}
...
<path d="M 2460 210 l -4 -4 m 4 4 l 4 -4 M 2460 150 l -4 4 m 4 -4 l 4 4" style="fill:none;stroke:#962896;stroke-width:1" />
	...
	el, ports, err := parseTwoPortDevice(n, ClassDisconnector, "49")
	if err != nil {
		t.Fatal(err)
	}
...
func TestParseTwoPortDevice_ChokeCoil_RotatedWithArcs(t *testing.T) {
	...
	el, ports, err := parseTwoPortDevice(n, ClassChokeCoil, "33")
	if err != nil {
		t.Fatal(err)
	}
...
func TestParseTwoPortDevice_CurrentTransformer(t *testing.T) {
	...
	el, ports, err := parseTwoPortDevice(n, ClassCurrentTransformer, "34")
	if err != nil {
		t.Fatal(err)
	}
...
<path d="M 1785 1130  l -3 -6 l 6 0 z M 1785 1134  l -3 6 l 6 0 z" style="fill:#962896;stroke:#962896;stroke-width:1" />
	...
	el, ports, err := parseTwoPortDevice(n, ClassSurgeArrester, "35")
	if err != nil {
		t.Fatal(err)
	}
...
func TestParseTwoPortDevice_Fuse(t *testing.T) {
	...
	el, ports, err := parseTwoPortDevice(n, ClassFuse, "203")
	if err != nil {
		t.Fatal(err)
	}
...
func TestParseTwoPortDevice_Capacitor(t *testing.T) {
	...
	el, ports, err := parseTwoPortDevice(n, ClassCapacitor, "388")
	if err != nil {
		t.Fatal(err)
	}
...
func TestParseJunctionPoint(t *testing.T) {
	...
	if el.Voltage != "#326400" {
		t.Errorf("voltage = %q, want #326400 (stroke, not the fill recorded in data-voltage)", el.Voltage)
	}
}
