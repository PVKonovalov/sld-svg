...
// of this file: 41, 43, 42, 162, 71, 49, 33, 34, 35, 203, 388.
func parseTwoPortDevice(n *rawNode, class Class, shape string) (Element, []Point, error) {
...
func parseGround(n *rawNode) (Element, []Point, error) {
	paths := elementPaths(n)
	if len(paths) == 0 {
...
func parseGroundSwitch(n *rawNode) (Element, []Point, error) {
...
func parseBusBar(n *rawNode) (Element, error) {
...
func parseJunctionPoint(n *rawNode) (Element, error) {
	...
	return Element{
		...
		Shape:   "7",
		Voltage: styleProp(n.attr("style"), "stroke"),
		Layer:   resolveLayer(n.attr("data-layer")),
		X:       cx,
		Y:       cy,
		Ports:   []Port{{Name: "1"}},
...
func parseConnector(n *rawNode) (Connector, error) {
	pts, err := parsePointList(n.attr("points"))
	if err != nil {
